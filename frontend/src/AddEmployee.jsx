...
function AddEmployee() {
  ...
  const calculateSalary = () => {
    const { basicSalary, bonus, deductions } = data;
  ...
  return (
    <div className='d-flex flex-column align-items-center pt-4'>
      ...
      <div className="col-12">
          <label htmlFor="inputEmployeeIndex" className="form-label">Employee Index</label>
          <input type="text" className="form-control" id="inputEmployeeIndex" placeholder='Enter Employee Index' autoComplete='off'
            onChange={e => setData({...data, employeeIndex: e.target.value})}/>
        </div>
        <div className="col-12">
        ...
        <div className="col-12">
          <button type="button" className="btn btn-primary" onClick={calculateSalary}>Calculate Salary</button>
        </div>
        {totalSalary !== null && (
          <div className="col-12">
